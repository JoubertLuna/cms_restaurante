...
@section('title', 'Detalhes do Garçom')

@section('content_header')
    <div align="left">
        <h1>Detalhes do Garçom <b>{{ $user->name }}</b></h1>
    </div>
    <div align="right">
        <a href="{{ route('waiter.index') }}" class="btn btn-danger"><i class="fas fa-backward"></i> Voltar</a>
    </div>
@stop
